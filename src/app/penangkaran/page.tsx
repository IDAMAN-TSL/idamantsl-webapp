          ...
          <table className="min-w-full border-collapse text-[12px]">
            <thead>
              ...
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="border border-gray-200 px-2 py-1.5 text-center font-semibold text-gray-700 min-w-22.5">
                  Perlindungan<br />Nasional
                </th>
                <th className="border border-gray-200 px-2 py-1.5 text-center font-semibold text-gray-700 min-w-20">
                  dalam<br />CITES
                </th>
                <th className="border border-gray-200 px-2 py-1.5 text-center font-semibold text-gray-700 min-w-20">
                  IUCN
