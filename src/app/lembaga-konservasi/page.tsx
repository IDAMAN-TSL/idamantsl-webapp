...
export default function LembagaKonservasiPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      setIsDeleting(true);
      const res = await fetch(`${API_URL}/api/lembaga-konservasi/${deleteTargetId}`, {
        method: "DELETE",
          ...
          <div className="relative w-full max-w-sm rounded-[22px] bg-white px-6 py-5 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.28)]">
            <div className="flex items-start gap-3 pr-8">
              ...
              <div className="pt-0.5">
                <h3 className="text-[15px] font-semibold text-gray-900">Hapus Data Lembaga Konservasi</h3>
              </div>
            </div>
