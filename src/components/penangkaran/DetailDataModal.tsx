...
interface PenangkaranDetailData {
  ...
  indukanJantan?: string | number | null;
  indukanBetina?: string | number | null;
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <ReadField id="detail-jantan" label="Indukan Jantan" value={String(data.indukanJantan ?? "-")} />
                <ReadField id="detail-betina" label="Indukan Betina" value={String(data.indukanBetina ?? "-")} />
              </div>
            </div>
          </div>
        </div>
