...
interface DetailDataModalProps {
  isOpen: boolean;
  onClose: () => void;
  data: PengedaranDetailData | null;
}
...
export function DetailDataModal({ isOpen, onClose, data }: Readonly<DetailDataModalProps>) {
  ...
  const jenisTsl = data.jenisTsl || data.tsl?.namaDaerah || "-";
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-2">
              <div className="flex flex-col gap-5">
                <ReadField id="detail-unit" label="Unit Pengedar DN" value={data.namaPengedaran} />
                ...
                <ReadField id="detail-alamat-pengedaran" label="Alamat Pengedar DN" value={data.alamatPengedaran} />
              ...
              <div className="flex flex-col gap-5">
                ...
                <ReadField id="detail-koordinat" label="Koordinat Pengedar DN" value={data.koordinatLokasi} />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <ReadField
                  id="detail-status-perlindungan-nasional"
                  label="Status Perlindungan Nasional"
                  value={statusPerlindunganNasional}
                />
                <ReadField
                  id="detail-status-cites"
                  label="Status CITES"
                  value={statusCites}
                />
                <ReadField
                  id="detail-status-iucn"
                  label="Status IUCN"
                  value={statusIucn}
                />
              </div>
