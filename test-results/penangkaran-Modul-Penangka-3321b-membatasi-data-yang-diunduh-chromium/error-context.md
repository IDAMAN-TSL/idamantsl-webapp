...
- Name: penangkaran.spec.ts >> Modul Penangkaran (Blackbox) >> checkbox baris harus membatasi data yang diunduh
- Location: test_bb\penangkaran.spec.ts:95:7
...
Call log:
  - waiting for locator('tbody tr').first().locator('input[type="checkbox"]')
